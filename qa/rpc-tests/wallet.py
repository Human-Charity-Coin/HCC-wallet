...
#   c) node1 mines 32 blocks, so now node 0 has 500000HCC, node 1 has 4250HCC, node2 has none.
#   d) node0 sends 601 HCC to node2, in two transactions (301 HCC, then 300 HCC).
