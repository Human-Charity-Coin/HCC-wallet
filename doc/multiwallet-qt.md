...
In order to support loading of multiple wallets in hcc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hcc.cpp.
...
Changes to hcc.cpp
----------------------
hcc.cpp is the entry point into hcc-qt, and as such, will require some minor modifications to provide hooks for
