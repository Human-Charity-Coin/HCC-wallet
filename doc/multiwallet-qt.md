...
In order to support loading of multiple wallets in human-charity-coin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is human-charity-coin.cpp.
...
Changes to human-charity-coin.cpp
----------------------
human-charity-coin.cpp is the entry point into human-charity-coin-qt, and as such, will require some minor modifications to provide hooks for
