...
- [Building Human-Charity-Coin](#building-hcc)
...
Clone the git repositories for hcc and gitian and then checkout the hcc version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the hcc repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the hcc repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/hcc/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/hcc/hcc
...
For example:
```bash
URL=https://github.com/konez2k/hcc.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit hcc=${COMMIT} --url hcc=${URL} ../hcc/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit hcc=${COMMIT} --url hcc=${URL} ../hcc/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit hcc=${COMMIT} --url hcc=${URL} ../hcc/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/hcc-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/hcc-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/hcc-build.assert
```
...
[hcc/gitian.sigs](https://github.com/hcc/gitian.sigs/) repository, or if that's not possible to create a pull
request.
