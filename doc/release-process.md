...
* Update translations see [translation_process.md](https://github.com/hcc/hcc/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Human-Charity-Coin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit hcc=v${VERSION} ../hcc/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit hcc=v${VERSION} ../hcc/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit hcc=v${VERSION} ../hcc/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit hcc=v${VERSION} ../hcc/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../hcc/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/hcc-*.tar.gz build/out/src/hcc-*.tar.gz ../
    popd
...
Codesigner only: Sign the osx binary:
    ...
    transfer hcc-osx-unsigned.tar.gz to osx for signing
    tar xf hcc-osx-unsigned.tar.gz
...
Codesigner only: Sign the windows binaries:
    ...
    tar xf hcc-win-unsigned.tar.gz
...
- Detached signatures will then be committed to the [hcc-detached-sigs](https://github.com/hcc/hcc-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/hcc/hcc/releases/new) with a link to the archived release notes.
