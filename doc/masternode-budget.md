...
Human-Charity-Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<human-charity-coin_address\> \<monthly_payment_human-charity-coin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ HCC, _12_ times over the course of a year totaling _24000_ HCC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<human-charity-coin_address\> \<monthly_payment_human-charity-coin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` HCC.
 ...
 * vote-many          - Vote on a Human-Charity-Coin initiative
 * vote-alias         - Vote on a Human-Charity-Coin initiative
 * vote               - Vote on a Human-Charity-Coin initiative/budget
