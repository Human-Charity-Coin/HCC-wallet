...
/** Utility functions used by the Human-Charity-Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render HCC addresses in monospace font
...
// Parse "human-charity-coin:" URI into recipient object, return true on successful parsing
