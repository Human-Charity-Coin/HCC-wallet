...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Human-Charity-Coin Core"),
     ...
     * override -datadir in the human-charity-coin.conf file in the default data directory
     * (to be consistent with human-charity-coind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
