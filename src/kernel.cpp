...
int nStakeTargetSpacing = 60; // Human-Charity-Coin: 1 minute blocks during POS (block 201+)
...
{
    // Human-Charity-Coin will hash in the transaction hash and the index number in order to make sure each hash is unique
