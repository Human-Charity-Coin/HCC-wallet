Contributing to Human-Charity-Coin Core
==================================

The Human-Charity-Coin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to human-charity-coin-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the human-charity-coin unit tests or QA tests
...
The following applies to code changes to the Human-Charity-Coin Core project, and is not to be
confused with overall Human-Charity-Coin Network Protocol consensus changes.

Whether a pull request is merged into Human-Charity-Coin Core rests with the project merge
...
Patches that change Human-Charity-Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Human-Charity-Coin consensus, it must have been
...
The project leader is the release manager for each Human-Charity-Coin Core release.
